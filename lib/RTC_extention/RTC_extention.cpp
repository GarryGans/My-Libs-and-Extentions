...
RTC_ext_3231::RTC_ext_3231(/* args */) : RTC_DS3231()
{
}

RTC_ext_3231::~RTC_ext_3231()
{
}

RTC_ext_1307::RTC_ext_1307(/* args */) : RTC_DS1307()
{
}

RTC_ext_1307::~RTC_ext_1307()
{
}
...
void RTC_ext_3231::adjustDate(const Date &dt)
{
...
void RTC_ext_3231::adjustTime(const Time &dt)
{
    Wire.beginTransmission(DS3231_ADDRESS);
...
void RTC_ext_1307::adjustDate(const Date &dt)
{
...
void RTC_ext_1307::adjustTime(const Time &dt)
{
    Wire.beginTransmission(DS1307_ADDRESS);
    Wire._I2C_WRITE((byte)0); // start at location 0
    Wire._I2C_WRITE(bin2bcd(dt.second()));
